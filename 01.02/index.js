...
const retired = ((age,retirementAge,salary,percentage)=>{
   if(age >= retirementAge){
       ...
       console.log(`you are going to work more ${yearsTosave} years till you retired`)
       ...
       console.log(`you will have money saved ${tillRetiredSave} till you are ${retirementAge}`);
